    ...
    <div id='app'>
      ...
      <nav className='navbar'>
        <div className='container'>
          <Link className='navbar-brand' to='/romana'>
            <img src='romana.png' width='65' height='65' />
          </Link>
          <Link className='navbar-brand' to='/matematica'>
            <img src='matematica.png' width='65' height='65' />
          </Link>
          <Link className='navbar-brand' to='/informatica'>
            <img src='informatica.png' width='65' height='65' />
          </Link>
          <Link className='navbar-brand' to='/biologie'>
            <img src='biologie.png' width='65' height='65' />
          </Link>
          <Link className='navbar-brand' to='/fizica'>
            <img src='fizica.png' width='65' height='65' />
          </Link>
          <Link className='navbar-brand' to='/chimie'>
